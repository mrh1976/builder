    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-24 px-8">
        <div className="max-w-[1280px] mx-auto flex flex-col items-center gap-12">
          ...
          <SplitTextReveal
            delay={500}
            className="w-full text-[56px] font-semibold leading-[72px] text-center bg-gradient-to-b from-brand-blue via-brand-blue to-brand-blue-gradient-end bg-clip-text text-transparent"
          >
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto">
          ...
          <div className="max-w-[1280px] grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
            ...
            <ScrollReveal delay={1000}>
              <div className="flex flex-col items-center gap-6 text-center">
                <svg className="w-24 h-24 text-brand-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3.5-9c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <div className="space-y-3">
                  <h3 className="text-2xl font-semibold text-black leading-8">
