                ...
                <div className="flex gap-4 items-start">
                  <div className="flex-shrink-0 w-24 h-24 bg-brand-dark rounded-lg overflow-hidden flex items-center justify-center">
                    ...
                    >
                      ...
                      <path
                        d="M20 40L40 25L60 40V55H20V40Z"
                        fill="#5C6CEC"
                        opacity="0.3"
                      />
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-black mb-2">
                      Beyond public vs. private chains: The Prividium
                      breakthrough
                    </h3>
                    <a
                      href="#"
                      className="text-brand-blue text-sm font-semibold inline-flex items-center gap-1 hover:underline"
                    >
                      Download
                      <svg
                        width="16"
                ...
                <div className="flex gap-4 items-start">
                  <div className="flex-shrink-0 w-24 h-24 bg-brand-dark rounded-lg overflow-hidden flex items-center justify-center">
                    ...
                    >
                      <rect width="80" height="80" fill="#0A0D12" />
                      <path
                        d="M20 50L40 25L60 50V58H20V50Z"
                        fill="#5C6CEC"
                        opacity="0.3"
                      />
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-black mb-2">
                      Memento ZK Chain: Creating the future of onchain fund
                      management
                    </h3>
                    <a
                      href="#"
